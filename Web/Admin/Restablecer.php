...
/*
		...
		if ($dato === $ip) {
		  echo "son iguales";
			...
			echo "revisar si es una ip";
			$ip ='8.8.8.8';
			echo ValidarIP($ip);

			if (ValidarIP($ip)==4){
				echo 'OK, comensar proceso';
			}
	...
	<div class="container">
      ...
      <!-- -------------- para detro  del titulo -------------------------- -->
          ...
          <table class="table table-hover">
                   ...
                   <tr><td><button type="button" class="btn btn-default" value="Valores_de_fabrica"		onclick="Comandos(this.value);"><i class="fa fa-plus fa-lg"></i>Valores de fabrica</button></td></tr>
      ...
      <!-- ---------------------------------------------------------------- -->
			...
			<form style="width: 100%;" class="create-button-form" id="formID" method="post" action="" class="formular" >
					...
					<input id="button" class="btn-inverse" type="submit" value="Test" name="Test"/>
